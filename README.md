...
- Timestamp: `2022-05-06 15:35`
- Build ID: `3b9a4159-4de8-4d7c-8269-9cadde7f15bb`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/3b9a4159-4de8-4d7c-8269-9cadde7f15bb.git
$ cd 3b9a4159-4de8-4d7c-8269-9cadde7f15bb
```
